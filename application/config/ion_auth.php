...
*/
$config['tables']['users']           = 'dbapp_users';
$config['tables']['groups']          = 'dbapp_groups';
$config['tables']['users_groups']    = 'dbapp_users_groups';
$config['tables']['login_attempts']  = 'dbapp_login_attempts';
 ...
 */
$config['site_title']                 = "Databased";       // Site Title, example.com
$config['admin_email']                = "info@chillyorange.com"; // Admin Email, admin@example.com
