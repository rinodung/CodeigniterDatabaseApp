    			...
    			<form action="<?php echo site_url('auth/reset_password/'.$code);?>" method="post">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="password" id="new" name="new" placeholder="<?php echo $this->lang->line('resetpassword_label_new_password')?>" pattern="^.{8}.*$" class="form-control">
    					</div>
    				</div>
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="password" id="new_confirm" name="new_confirm" placeholder="<?php echo $this->lang->line('resetpassword_label_new_password_confirm')?>" pattern="^.{8}.*$" class="form-control">
    					</div>
    				</div>
    				...
    				<button type="submit" class="btn btn-primary btn-embossed btn-block margin-top-20"><?php echo $this->lang->item('resetpassword_button')?></button>
