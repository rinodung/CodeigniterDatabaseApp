...
class UserModel extends CI_Model {
    ...
    */
    ...
    public function newUser($data)
    {
    	...
    	$mysqlUser = $newUserId."_".preg_replace("/[^a-zA-Z0-9]+/", "", $data['firstname']);
    	
    	$this->db->query("CREATE USER '".$mysqlUser."'@'".$this->db->hostname."' IDENTIFIED BY '".$data['password']."'");
    	...
    	//save mysql credentials for the new user
    	$dataa = array(
    	   'mysql_user' => $mysqlUser,
    	   'mysql_pw' => $this->encrypt->encode($data['password'])
    	);
    	...
    	if( $data['group'] > 1 ) {
    		...
    		$this->rolemodel->applyPermissions($permissions, $mysqlUser);
    ...
    */
    ...
    public function hasDBPermission($permission, $db)
    {
    	...
    	if(isset($permissions[$db][$permission])) {
    ...
    */
    ...
    public function ownsTable($db, $table) 
    {
    ...
    */
    ...
    public function hasTablePermission($permission, $db, $table) 
    {
    	...
    	if(isset($permissions[$db][$table][$permission])) {
    ...
    */
    ...
    public function deleteUser($userID)
    {
    	...
    	//delete all column notes first
    	
    	$this->db->where('dbapp_columnnotes_userid', $userID);
