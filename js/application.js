...
(function($) {
  ...
  $(function() {
    ...
    // Custom Selects
    $("select.huge").selectpicker({style: 'btn-hg btn-primary', menuStyle: 'dropdown-inverse'});
    $("select.large").selectpicker({style: 'btn-lg btn-danger'});
    $("select.info").selectpicker({style: 'btn-info'});
    $("select.default").selectpicker({style: 'btn-default'});
    $("select.small").selectpicker({style: 'btn-sm btn-warning'});
